...
public class SimpleInfoCard : CardMessageBase
{
    ...
    public SimpleInfoCard(IEnumerable<string> content, string title = null, IEnumerable<string> remark = null,
    ...
    public SimpleInfoCard(string content, string title = null, string remark = null, bool showFooter = false)
    {
        ...
        IEnumerable<string> remark, bool showFooter)
    {
        CardBuilder card = new CardBuilder()
            ...
            .WithColor(CardHelper.CrowdinGreen);
